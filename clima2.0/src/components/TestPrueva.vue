  ...
  <template>
   ...
   <!--    <h2 v-if="weatherData && weatherData.name">Condiciones meteorológicas actuales en {{ weatherData.name }}</h2>
    ...
    <div class="card-body">
      ...
      <a href="https://elpais.com/espana/catalunya/2024-04-19/cataluna-vuelve-a-cambiar-de-rumbo-frente-a-la-sequia-de-agua-con-barcos-a-una-desaladora-portatil-en-el-mar-de-barcelona.html" class="btn btn-primary">Go somewhere</a>
    </div>
  </div>
